...
{
    public partial class CompanionTool : PluginControlBase, IGitHubPlugin, ICodePlexPlugin, IPayPalPlugin, IHelpPlugin, IStatusBarMessenger, IShortcutReceiver, IAboutPlugin, IDuplicatableTool, ISettingsPlugin, IPrivatePlugin, IMessageBusHost, ICompanion
    {
        #region Base tool implementation

        public CompanionTool()
        {
            InitializeComponent();
        ...
        #region Companion implementation
        ...
        #endregion Companion implementation
